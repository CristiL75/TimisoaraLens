"""
Add Timișoara 2023 (European Capital of Culture) chunks to Qdrant.
Reads data/timisoara_2023_chunks.json produced by scrape_timisoara_2023.py
"""
...
CHUNKS_FILE = Path(__file__).parent.parent / "data" / "timisoara_2023_chunks.json"
...
def add_to_qdrant():
    ...
    for i, chunk in enumerate(chunks):
        ...
        payload = {
            ...
            "category": chunk.get("category", "Timișoara 2023"),
            "period": chunk.get("period", "2023"),
            "source": chunk.get("source", "Visit Timișoara - European Capital of Culture"),
            "url": chunk.get("url", "https://visit-timisoara.com/timisoara-2023/"),
        }
        points.append({"id": doc_id, "vector": embedding, "payload": payload})
        print(f"  ✅ {i+1}. {chunk['heading'][:60]}... (ID: {doc_id})")
