"""
Add Timișoara History chunks to Qdrant
Embeds and upserts optimized historical chunks
"""
...
from scrape_timisoara_history import get_timisoara_history_chunks
...
def add_to_qdrant():
    """Embed and upsert Timișoara History chunks to Qdrant."""
    ...
    print(f"\n📝 Processing {len(chunks)} historical chunks...")
